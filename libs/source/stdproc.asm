...
BLOCK_STRUCT_SIZE         EQU 4 * REG_BYTE_SIZE
ATTR_BLOCK_FLAG           EQU 0 * REG_BYTE_SIZE
ATTR_BLOCK_SIZE           EQU 1 * REG_BYTE_SIZE
ATTR_BLOCK_PREV           EQU 2 * REG_BYTE_SIZE
ATTR_BLOCK_NEXT           EQU 3 * REG_BYTE_SIZE

ATTR_OBJ_CLASS_ID         EQU 0 * REG_BYTE_SIZE
ATTR_STR_LENGTH           EQU 1 * REG_BYTE_SIZE
ATTR_ARY_LENGTH           EQU 1 * REG_BYTE_SIZE
ATTR_OBJ_DATA_OFFSET      EQU 2 * REG_BYTE_SIZE

; reserved system data
FIRST_BLOCK               EQU 0 * REG_BYTE_SIZE
FREE_BLOCK_SIZE           EQU 1 * REG_BYTE_SIZE
USED_BLOCK_SIZE           EQU 2 * REG_BYTE_SIZE
GARBAGE_COUNT             EQU 3 * REG_BYTE_SIZE

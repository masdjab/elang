...
class TestLangIntel32 < Test::Unit::TestCase
  def setup
  ...
  def test_load_immediate
    check_bin @language.load_immediate(0), "B801000000"
    check_bin @language.load_immediate(0x2000), "B801400000"
  end
  def test_load_str
    check_bin @language.load_str(""), "B80000000050E800000000"
  end
  def test_get_global_variable
    check_bin @language.get_global_variable(nil), "A100000000"
  end
  def test_set_global_variable
    check_bin @language.set_global_variable(nil), "50A10000000050E80000000058A300000000"
  end
  def test_get_local_variable
    check_bin @language.get_local_variable(nil), "8B4500"
  end
  def test_set_local_variable
    check_bin @language.set_local_variable(nil), "508B450050E80000000058894500"
  end
  def test_get_instance_variable
    check_bin @language.get_instance_variable(nil), "B800000000508B450450E800000000"
  end
  def test_set_instance_variable
    check_bin @language.set_instance_variable(nil), "50B800000000508B450450E800000000"
  end
  ...
  def test_get_class
    check_bin @language.get_class(nil), "A400000000"
  end
  def test_set_class
    check_bin @language.set_class(nil), "A700000000"
  end
  def test_get_method_id
    check_bin @language.get_method_id(""), "B800000000"
  end
  def test_push_argument
    check_bin @language.push_argument, "50"
  end
  def test_call_function
    check_bin @language.call_function(nil), "E800000000"
  end
  def test_call_sys_function
    check_bin @language.call_sys_function(""), "E800000000"
  end
  def test_create_object
    check_bin @language.create_object(Elang::Class.new(Elang::Scope.new, 'Person', nil, 1)), "B80000000050B80100000050E800000000"
  end
=begin

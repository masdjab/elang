module Elang
  class Linker16
    ...
    def build_reserved_image(build_config)
      build_config.reserved_image = 0.chr * (2 * build_config.reserved_var_count)
    end
    ...
    def calc_dynamic_area(build_config)
      build_config.dynamic_area = build_config.variable_offset + (build_config.root_var_count * 2)
    end

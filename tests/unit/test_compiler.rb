...
class CompilerTest < Test::Unit::TestCase
  ...
  def check_binary(actual, expected_str)
    assert_equal actual, Elang::Utils::Converter.hex_to_bin(expected_str)
  end
  def test_link_main_code
    source = "x = 2\r\ny = 3\r\nz = x + y\r\n"
    codeset = compile(source)
    check_binary codeset.subs_code, ""
    check_binary codeset.main_code, "b80500a20000b80700a20000a1000050a1000050e84180a20000"
  end
...
EOS
    ...
    codeset = compile(source)
    check_binary codeset.subs_code, "5589e5a1000050b8030050e841805dc20200"
    check_binary codeset.main_code, "b8050050e80000a20000a1000050e80000a20000"
  end
